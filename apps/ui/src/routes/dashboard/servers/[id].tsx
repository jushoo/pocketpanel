  ...
  return (
    <div class="min-h-screen bg-background">
      ...
      <main class="mx-auto max-w-4xl px-6 py-8">
        <Suspense fallback={<div class="text-center py-12">Loading...</div>}>
          <Show
            when={server()}
            fallback={<div class="text-center py-12">Server not found</div>}
          >
            {(s) => (
              <>
                {/* Title */}
                ...
                <div class="space-y-6">
                  ...
                  <div class="pb-6 border-b border-border">
                    ...
                    <div class="flex items-center gap-3">
                      <p class="text-foreground">v{s().server.version}</p>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <p class="mt-1 font-medium text-foreground">
                          {formatMemory(s().server.min_mem)} -{" "}
                          {formatMemory(s().server.max_mem)}
                        </p>
                      </div>
                      <div>
