...
func TestListServers(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupDB: func() {
				db.Create(&models.Server{Name: "server1", Type: "vanilla", Version: "1.20.4", MinMem: 2048, MaxMem: 4096, Port: 25565})
				db.Create(&models.Server{Name: "server2", Type: "fabric", Version: "1.20.4", MinMem: 2048, MaxMem: 4096, Port: 25566})
			},
